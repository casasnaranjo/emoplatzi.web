...
namespace EmotionPlatzi.web.Controllers
{
    public class EmoEmotionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,EmoFaceId,score,EmotionType")] EmoEmotion emoEmotion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,EmoFaceId,score,EmotionType")] EmoEmotion emoEmotion)
        {
            if (ModelState.IsValid)
            {
